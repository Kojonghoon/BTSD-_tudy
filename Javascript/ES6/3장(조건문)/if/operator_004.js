...
// alert("3.14를 실수로 바꾸면 ? = " + Number.parseFloat(someValue2))	//3.14
// alert(Number.parseFloat(3.00))	//3
// alert(Number.parseFloat(someValue2))
// alert(Number.isInteger(Number.parseFloat(3.00)))	//3
...
// alert(`변수 a의 출력 값은 = ${a1}이고, 타입은 = ${typeof (a1)}`)	//100, number
...
alert(`변수 b의 출력 값은 = ${b1}이고, 타입은 = ${typeof (b1)}`)	//3.14, number
